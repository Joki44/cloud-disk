...
export default function userReducer(state = defaultState, action) {
    switch (action.type) {
        case SHOW_UPLOADER: return {...state, isVisible: true, isOpen: true}
        case HIDE_UPLOADER: return {...state, isVisible: false, isOpen: false}
        case OPEN_UPLOADER: return {...state, isVisible: true, isOpen: true}
        case CLOSE_UPLOADER: return {...state, isVisible: true, isOpen: false}
...
export const openUploader = () => ({type: OPEN_UPLOADER})
export const closeUploader = () => ({type: CLOSE_UPLOADER})
